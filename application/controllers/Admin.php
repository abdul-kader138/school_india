...
class Admin extends CI_Controller
{
  ...
  function student_profile($student_id)
  {
    ...
    function get_subject1($class_id) {
          $page_data['class_id'] = $class_id;
          $this->load->view('backend/admin/manage_attendance_subject_holder1' , $page_data);
    }
    ...
    function attendance_selector()
    {
        ...
        redirect(site_url('admin/manage_attendance_view/' . $data['class_id'] . '/' . $data['section_id'] . '/' . $data['timestamp'] . '/' . $data['subject_id']),'refresh');
    }
    ...
    function attendance_update($class_id = '' , $section_id = '' , $timestamp = '' , $subject_id = '')
    {
        ...
        $attendance_of_students = $this->db->get_where('attendance' , array(
            'class_id'=>$class_id,'section_id'=>$section_id,'year'=>$running_year,'subject_id'=>$subject_id,'timestamp'=>$timestamp
        ))->result_array();
        ...
        redirect(site_url('admin/manage_attendance_view/'.$class_id.'/'.$section_id.'/'.$timestamp.'/'.$subject_id) , 'refresh');
    }
