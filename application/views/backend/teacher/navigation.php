    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'manage_attendance' ||
            ...
            <ul>
                    ...
                    <li class="<?php if (( $page_name == 'attendance_report_view' || $page_name == 'attendance_report_view')) echo 'active'; ?>">
                        <a href="#">
                    ...
                    <ul>
                        ...
                        <li class="<?php if (( $page_name == 'attendance_report_view_monthly' || $page_name == 'attendance_report_view_monthly')) echo 'active'; ?>">
                            <a href="<?php echo site_url('teacher/attendance_report_monthly'); ?>">
                                <span><i class="entypo-dot"></i><?php echo get_phrase('monthly_attendance_report'); ?></span>
                            </a>
                        </li>
                        <li class="<?php if (( $page_name == 'attendance_report_view_yearly' || $page_name == 'attendance_report_view_yearly')) echo 'active'; ?>">
                            <a href="<?php echo site_url('teacher/attendance_report_yearly'); ?>">
                                <span><i class="entypo-dot"></i><?php echo get_phrase('yearly_attendance_report'); ?></span>
                            </a>
                        </li>
						<li class="<?php if (( $page_name == 'attendance_report_view_subject' || $page_name == 'attendance_report_view_subject')) echo 'active'; ?>">
                            <a href="<?php echo site_url('teacher/attendance_report_subject'); ?>">
